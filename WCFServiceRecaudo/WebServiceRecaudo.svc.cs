...
namespace WCFServiceRecaudo
{
    ...
    public class wsRecaudo : IWSRecaudo
    {
        ...
        /// estado del cupon
        /// <returns></returns>
        public List<DatosCuponPago> obtenerDatosCuponPago(int nuIdcuponpago)
        {
        ...
        /// <returns></returns>
        public List<DatosSuscriptor> obtenerDatosSuscriptor(int nuIdsuscriptor)
        {
        ...
        /// </returns>
        public bool obtenerEstadoFacturacion(int nuIdsuscriptor)
        {
